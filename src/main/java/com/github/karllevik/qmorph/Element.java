...
/**
  This class declares methods and variables that are common to quads and triangles.
*/
...
public abstract class Element extends Constants {
    ...
    /** Compute & set the angle at this particular Node incident with this Element Edge*/
