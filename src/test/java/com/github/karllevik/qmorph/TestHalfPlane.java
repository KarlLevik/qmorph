...
import com.github.karllevik.qmorph.*;
...
class TestHalfPlane {
	...
	if (p1.inHalfplane(t, e1)==1) 
	    Msg.error("p1 incorrectly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.debug("p1 correctly detected not to belong to halfplane left of Edge "+
		      e1.descr());

	if (p2.inHalfplane(t, e1)==1) 
	    Msg.error("p2 incorrectly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.debug("p2 correctly detected not to belong to halfplane left of Edge "+
		      e1.descr());


	if (p3.inHalfplane(t, e1)==1) 
	    Msg.error("p3 incorrectly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.debug("p3 correctly detected not to belong to halfplane left of Edge "+
		      e1.descr());


	if (p4.inHalfplane(t, e1)==1) 
	    Msg.error("p4 incorrectly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.debug("p4 correctly detected not to belong to halfplane left of Edge "+
		      e1.descr());
	...
	if (p1.inHalfplane(t, e1)==1) 
	    Msg.debug("p1 correctly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.error("p1 incorrectly detected not to belong to halfplane left of Edge "+
		      e1.descr());

	if (p2.inHalfplane(t, e1)==1) 
	    Msg.debug("p2 correctly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.error("p2 incorrectly detected not to belong to halfplane left of Edge "+
		      e1.descr());


	if (p3.inHalfplane(t, e1)==1) 
	    Msg.debug("p3 correctly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.error("p3 incorrectly detected not to belong to halfplane left of Edge "+
		      e1.descr());

	if (p4.inHalfplane(t, e1)==1) 
	    Msg.debug("p4 correctly detected to belong to halfplane left of Edge "+
		      e1.descr());
	else 
	    Msg.error("p4 incorrectly detected not to belong to halfplane left of Edge "+
		      e1.descr());
	...
	if (p.inHalfplane(abc, bc)==1) 	    
	    Msg.debug("p correctly detected to belong to halfplane right of Edge "+
		      bc.descr());
	else 
	    Msg.error("p incorrectly detected not to belong to halfplane right of Edge "+
		      bc.descr());
	...
	if (q.isStrictlyConvex())
	    ...
	    Msg.debug("method correctly reports that Quad "+q.descr()+
